...
async function syncToServer(dataType, dataArray) {
    try {
        ...
        const response = await fetch(`https://115e-78-99-54-47.ngrok-free.app/${dataType}`);
        ...
        for (const item of dataArray) {
            ...
            if (existingItem) {
                ...
                await fetch(`https://115e-78-99-54-47.ngrok-free.app/${dataType}/${existingItem.id}`, {
                    method: 'DELETE',
                });
            ...
            // Додаємо новий запис
            await fetch(`https://115e-78-99-54-47.ngrok-free.app/${dataType}`, {
                method: 'POST',
                headers: {
